...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    //API location
    String postReceiverUrl="http://www.wepathit.com/API/V1/CustomerLogin/Login.php";
    //Server response string
    String responseStr=null;

    //File to Store the status
    String PREF_FILE = "Status";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Shared preferences to store the status
        SharedPreferences LoginStatus = getSharedPreferences(PREF_FILE,0);
        if(LoginStatus.getBoolean("IsLoggedIn",false)){
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String success) {
            ...
            if (responseStr.contains("TRUE")) {
                Log.d("output", "Response inside if : " + responseStr);
                Intent i = new Intent(getApplicationContext(), PlacePickerActivity.class);
                SharedPreferences LoginStatus = getSharedPreferences(PREF_FILE,0);
                LoginStatus.edit().putBoolean("IsLoggedIn",true).apply();
                startActivity(i);
                finish();
